...
public class AccumulationHandler extends RecUnitHandler {
     ...
     */
    private void createRecResult(RecInputParams recInputParams, RecStatusParams recStatusParams, ActiveBundle activeBundle) {
