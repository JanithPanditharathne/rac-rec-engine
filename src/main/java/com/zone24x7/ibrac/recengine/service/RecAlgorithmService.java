...
public class RecAlgorithmService implements AlgorithmService {
     ...
     */
    public AlgorithmResult getAlgorithmResult(String algorithmId, Map<String, String> ccp, RecCycleStatus recCycleStatus) throws BaseConnectionException {
        //TODO: Call algorithm combination iterator
        //TODO: Support multiple other ways
        return datasourceAdapter.getResult(algorithmId, ccp, recCycleStatus);
    }
}
