...
public class RecAlgorithmCombinator implements AlgorithmCombinator {
     ...
     */
    private MultipleAlgorithmResult getMultipleResultWhenCombinedEnabled(Map<String, Future<AlgorithmResult>> futures, ActiveBundle activeBundle, Map<String, String> algoIdToDisplayText, RecCycleStatus recCycleStatus) {
        ...
        for (Map.Entry<String, Future<AlgorithmResult>> entry : futures.entrySet()) {
            ...
            if (algorithmResult != null) {
                ...
                if (CollectionUtils.isEmpty(products) && CollectionUtils.isNotEmpty(recProducts) && (recProducts.size() >= activeBundle.getLimitToApply())) {
