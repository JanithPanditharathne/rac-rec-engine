...
class DroolsRecRuleExecutorTest {
    ...
    public void setup() {
        ...
        knowledgeBuilder.add(ResourceFactory.newFileResource(Paths.get("").toAbsolutePath() + "/src/test/java/com/zone24x7/ibrac/recengine/recrules/executors/RecTestRules.drl"), ResourceType.DRL);
